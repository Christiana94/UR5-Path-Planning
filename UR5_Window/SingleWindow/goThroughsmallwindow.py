...
if clientID!=-1:
    ...
    #Configuration for small window
    tryConfigS_1 = [-1.0110,  -0.9291,    0.5916,    0.3375,    2.1395,    0.7224]
    tryConfigS_2 = [-1.0110,  -0.9291,    0.5916,    0.3375,    0.5000,    -0.7000]
    ...
    tryConfig = [tryConfigS_1, tryConfigS_2]
